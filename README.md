...
- Parameter editing
- Export-specific instance surfaces, including a chunked ShadowGrain ring-buffer overview, OSC-list editing for ListSequencer and ListVelSequencer, and a local ShadowScoreClient playback display
- Preset loading
...
- Contract-validated instance surfaces for Organ, AnalogSequencer, TimeDomainScope, ShadowGrain, Tuner, ListSequencer, ListVelSequencer, and ShadowScoreClient
