...
- On the ListSequencer surface, keypad digits enter numbers, `+` enters a space, `.` deletes, `-` toggles the current sign, `Enter` sends, `/` / `*` select the previous / next field, and `Tab` cycles to the next field.
